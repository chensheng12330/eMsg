...
+ (NSString *)publicIPAddress
{
    ...
    NSRange range = [html rangeOfString:@"\\d+\\.\\d+\\.\\d+\\.\\d+" options:NSRegularExpressionSearch];
    
    NSString *ip = [html substringWithRange:range];
...
+(CGSize)absoluteScreenSize {
    ...
    if(screenSize.width > screenSize.height) {
        ...
        resize.width = screenSize.height;
        resize.height = screenSize.width;
